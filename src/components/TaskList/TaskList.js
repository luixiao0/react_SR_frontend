...
function DummyTaskcard(props) {
  return (
    <>
      <div key={props.id} className={"bg-white dark:bg-gray-900 rounded-xl py-4 text-center select-none"} >
  ...
  render() {
    ...
    return (
      <div className="w-full">
        <div className="bg-white dark:bg-gray-900 shadow-sm rounded-xl mt-2 p-1 mx-2">
